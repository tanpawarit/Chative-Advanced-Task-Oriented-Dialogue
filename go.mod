module github.com/tanpawarit/Chative-Advanced-Task-Oriented-Dialogue
...
require (
	...
	github.com/cloudwego/eino-ext/components/model/openai v0.0.0-20250811024657-1a3a29c65eb4 // indirect
